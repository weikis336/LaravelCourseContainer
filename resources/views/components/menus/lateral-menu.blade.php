...
<nav class="sidebar">
    <div class="navigation">
        ...
        {{-- <li><a href="{{ route('admin.dashboard') }}">Gestion Usuarios</a></li> --}}
        <div class="buttons">
            <div class="button-logout">
                <a href="{{ route('logout') }}">
                    <span>Log Out</span>
                    <svg width="64px" height="800px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<div class="panel-menu">
    ...
    <label for="btn-nav" class="btn-nav"><span></span></label>
</div>